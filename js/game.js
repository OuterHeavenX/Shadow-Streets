...
export class Game {
    ...
    start(districtId = null) {
        ...
        weaponPickups.reset(); environment.reset(); weather.reset(); audio.startMusic();
        this.loop.start();
    }
    ...
    changeDistrict(id) {
        this.world.loadDistrict(id); streetJuice.decorate(this.world.district);
        saveSystem.setCurrentDistrict(id);
        this.player.x = 100; this.player.y = 375; this.player.depthVy = 0; this.player.z = 0; this.player.isGrounded = true;
